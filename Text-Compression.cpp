...
int computeBits(unordered_map<char, int> freq, unordered_map<char, string> huffmanCode)
{
  int totalBits = 0;
...
string getBinaryString(unordered_map<char, string> huffmanCode, string plaintext)
{
  string binary;
...
void getHuffmanCode(Node *root, string str, unordered_map<char, string> &huffmanCode)
{
...
int main(int argc, char **argv)
{
  ...
  while (!file.eof())
  {
    ...
    { // If First line in file, make firstline to false
      firstLine = false;
    }
